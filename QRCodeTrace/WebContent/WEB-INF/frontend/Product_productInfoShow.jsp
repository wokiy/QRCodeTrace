    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="${rootPath}/Product_productInfoShow">产品展示</a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
         <div class="article_vert">
             ...
             <div>
                <section id="work"> <!-- 产品展示列表 Start -->
                <s:if test="#request.productList !=null && #request.productList.size() >0">
                 	<s:iterator var="product" value="%{#request.productList}" status="st">
	    	            <div class="item">
	        	            <img src="<s:property value='#product.pic' />" alt="image <s:property value='#st.count' />"/><!-- Image must be 400px by 300px -->
	                        <h3><s:property value='#product.name' /></h3><!--Title-->
	                    </div><!--/item-->
                    </s:iterator>
                    </s:if>
                    <s:else>
                             ...
                             <td style="font-size: 12px; height: 40px; text-align: right; color: #696969; font-weight: bold;"
                                 ...
                                 <s:if test="#request.pageRow >= #request.totalRow"></s:if>
                                  <s:elseif test="#request.pageNo <= 1 || #request.pageNo==null">
	                                ...
	                                <a href="${rootPath}/Product_productInfoShow?pageNo=<s:property value='#pageNo + 1'/>">下一页</a>
	                                <a href="${rootPath}/Product_productInfoShow?pageNo=<s:property value='#totalPage'/>">尾页</a>
		                             <s:form name="pageNoForm" action="Product_productInfoShow" style="display:inline-block" theme="simple" onsubmit="return checkPage()">
                    			  ...
                    			  <s:elseif test="#request.pageNo >= #request.totalPage">
	                                ...
	                                &nbsp; <span style="font-size: 12px;">10</span>条/页 
	                                <a href="${rootPath}/Product_productInfoShow?pageNo=<s:property value='1'/>">首页</a>
	                                <a href="${rootPath}/Product_productInfoShow?pageNo=<s:property value='#totalPage-1'/>">上一页</a>
		                             <s:form name="pageNoForm" action="Product_productInfoShow" style="display:inline-block" theme="simple" onsubmit="return checkPage()">
		                                 <input id="pageNo" name="pageNo" type="text" maxlength="6" style="border-color: #A0B52E; border-width: 1px;
		                                     border-style: Solid; width: 20px;"/>
		                                 <input type="submit" value="跳转"/>
