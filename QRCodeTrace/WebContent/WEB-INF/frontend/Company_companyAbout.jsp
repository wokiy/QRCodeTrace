...
<head>
<title>公司概况|<s:property value="#request.companyInfo.name"/>果蔬有限公司</title>
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="${rootPath}/Company_companyAbout">公司概况</a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
         <div class="article_vert">
              ...
              <div style=" width:95%; ">
                  <p>&nbsp;&nbsp;&nbsp;&nbsp;<s:property value="#request.companyInfo.introduction" /> </p>
              </div>
          </div>
         <div class="clr"></div>
      </div>
