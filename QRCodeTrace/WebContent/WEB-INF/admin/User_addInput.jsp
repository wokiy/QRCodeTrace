...
<div id="content">
	<c:import url="public/left_menu.jsp"></c:import>
		<div class="m-right">
			...
			<div class="main" >
			<s:form action="User_userSave" method="post" theme="simple" enctype="multipart/form-data" onsubmit="return checkAll()">
			 <s:token></s:token>
                <div >
                    ...
                    <table class="table" style="margin-left:10px; width:100%">            
                        <tr>
                            ...
                            <td><s:textfield id="userName" name="userName" onfocus="userNameTip()" onblur="checkUserName()"></s:textfield>
                            <span id="userNameTip"></span><span style="color:red"><s:property value="#request.msg"/></span></td>
                        </tr>
                        <tr>
                            <td>密码</td>
                            <td><s:textfield type="password" id="userPassword" name="password" onfocus="userPasswordTip()" onblur="checkUserPassword()"></s:textfield><span id="userPasswordTip"></span> </td>
                        </tr>
                        <tr>
                            <td>权限</td>
                        ...
                        <tr>
                            <td>执照图片</td>
                            <td><s:file name="licensePicImage"></s:file></td>
                        </tr>
                        <tr>
                            <td>联系方式</td>
				...
				<div style="margin-left:30px">
                    ...
                    <a href="${rootPath}/User_userInfoShow"><button type="button" class="btn btn-default">返回</button></a>            
                </div>
                </s:form>
			</div>
		</div>
