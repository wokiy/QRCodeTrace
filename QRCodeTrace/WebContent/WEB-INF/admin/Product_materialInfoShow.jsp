			...
			<div class="main" >
                ...
                <s:hidden id="permission" value="%{#session.permissionMsg}"></s:hidden>
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="${rootPath}/Product_materialInfoShow">原料信息</a></li>
                    ...
                    <div style="margin:10px">
                       <s:form action="Product_materialProductSearch" theme="simple" style="display:inline-block">
                    ...
                    <s:iterator var="product" value="%{#request.productList}" status="st">
                        <tr>
                            ...
                            <td>
                            <s:url var="urlAdd" action="Material_addInput">
                            	<s:param name="pro_id" value="%{#product.id}"></s:param>
                            </s:url>
                            <s:url var="urlDesc" action="Material_updateInput">
                            	<s:param name="pro_id" value="%{#product.id}"></s:param>
                            </s:url>
                            	<!-- ${rootPath}/Material_view_materialAdd -->
                            	<!-- <s:property value='%{#urlA}'/>-->
                            	<!--<s:property value='%{#product.material}'/> -->
                            	<!-- <s:if test="%{#product,material} ==null"/> 是错误的,要写在{里面} -->
                            	<s:if test="#product.material == null">
                ...
                <s:if test="#request.pageRow >= #request.totalRow"></s:if>
                    <s:elseif test="#request.pageNo <= 1 || #request.pageNo==null">
	                   <a href="${rootPath}/Product_materialInfoShow?pageNo=<s:property value='#pageNo + 1'/>" style="margin-left:300px" ><button class="btn btn-default" type="button">下一页</button></a>
                       <a href="${rootPath}/Product_materialInfoShow?pageNo=<s:property value='#totalPage'/>"><button class="btn btn-default" type="button">末页</button></a>
                       <span><s:property value="#request.totalRow"/></span>条产品信息
                       &nbsp;&nbsp;1/<s:property value="#request.totalPage"/>
                        <span>
	                        <s:form action="Product_materialInfoShow" style="display:inline-block" theme="simple" onsubmit="return checkPage()">
                    ...
                    <s:elseif test="#request.pageNo >= #request.totalPage">
                        <a href="${rootPath}/Product_materialInfoShow?pageNo=<s:property value='1'/>" style="margin-left:300px"><button class="btn btn-default" type="button">首页</button></a>
	                    <a href="${rootPath}/Product_materialInfoShow?pageNo=<s:property value='#totalPage-1'/>"><button class="btn btn-default" type="button">上一页</button></a>
	                    <span><s:property value="#request.totalRow"/></span>条产品信息
	                ...
	                <s:else>
	                	<a href="${rootPath}/Product_materialInfoShow?pageNo=<s:property value='1'/>" style="margin-left:300px"><button class="btn btn-default" type="button">首页</button></a>
	                    <a href="${rootPath}/Product_materialInfoShow?pageNo=<s:property value='#pageNo - 1'/>"><button class="btn btn-default" type="button">上一页</button></a>
	                    <a href="${rootPath}/Product_materialInfoShow?pageNo=<s:property value='#pageNo + 1'/>"><button class="btn btn-default" type="button">下一页</button></a>
                        <a href="${rootPath}/Product_materialInfoShow?pageNo=<s:property value='#totalPage'/>"><button class="btn btn-default" type="button">末页</button></a>
                        <span><s:property value="#request.totalRow"/></span>条产品信息
