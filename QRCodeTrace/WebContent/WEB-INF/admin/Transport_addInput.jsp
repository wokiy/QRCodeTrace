...
<div id="content">
	<c:import url="public/left_menu.jsp"></c:import>
		<div class="m-right">
			...
			<div class="main" >
			<s:form name="transport_form" action="Transport_transportSave" method="post" theme="simple" onsubmit="return checkAll()">
			 <s:token></s:token>
                <div >
                    ...
                    <tbody>
                       <tr>
                        ...
                        <tr>
                            <td>运输出发时间</td>
                            <td><s:textfield id="dateValue" name="departureTime" onclick="WdatePicker()" onblur="checkDate();"></s:textfield>
                            <span id="tip"></span></td>
                        </tr>
                        <tr>
                            <td>运输到达时间</td>
                            <td><s:textfield id="dateValue2" name="arrivalTime" onclick="WdatePicker()" onblur="checkDate2();"></s:textfield>
                            <span id="tip2"></span></td>
                        </tr>
                        <tr>
                            <td>运输负责人姓名</td>
				...
				<div style="margin-left:30px">
                    ...
                    <a href="${rootPath}/Product_transportInfoShow"><button class="btn btn-default" type="button">返回</button></a>         
                </div>
                </s:form>
			</div>
		</div>
