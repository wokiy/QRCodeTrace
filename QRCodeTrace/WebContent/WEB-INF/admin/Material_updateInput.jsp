...
<div id="content">
	<c:import url="public/left_menu.jsp"></c:import>
		<div class="m-right">
			...
			<div class="main" >
			<s:form action="admin/Material_materialUpdate" method="post" theme="simple">
			 <s:token></s:token>
                <div >
				...
				<div style="margin-left:30px">
					...
					<a href="${rootPath}/Material_materialDelete?id=<s:property value='id'/>"><input class="btn btn-default" type="button" value="删除"/></a>
                    <a href="${rootPath}/Product_materialInfoShow"><input class="btn btn-default" type="button" value="返回"/></a>         
                </div>
                </s:form>
			</div>
		</div>
