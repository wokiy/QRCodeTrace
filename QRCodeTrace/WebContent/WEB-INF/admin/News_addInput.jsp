...
<div id="content">
	<c:import url="public/left_menu.jsp"></c:import>
		<div class="m-right">
			<div class="main" >
			<s:form name="News_form" action="News_newsSave" method="post" theme="simple" >
			 <s:token></s:token>
                <div style="width:100%; margin-top:10px; margin-left:10px" >
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th><s:textfield name="title" maxlength="115" style="width:99%"></s:textfield> </th>
                        </tr>
                        </thead>
                        <tbody>
                            <tr style="height:350px">
                                <td style="width:5%">内容</td>
                                <td ><s:textarea class="ckeditor" id="newsContent" name="content" style="height:100%;width:99%"></s:textarea> </td>
                            </tr>
                        </tbody>
                    </table>
